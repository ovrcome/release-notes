...
- Add backend foundations for capturing privacy consent from clients.

### Fixed

- Fix error resizing full-size 360º reference images when generating content requests.
- Fix error using smart hierarchy generator.

### Changed

- Migrated existing clinic feature flags to also apply to organisations.
...
- Upgrade to Hanami 3.0.
- Set up test environment using ARM architecture.
...
- Adjust visibility and wording in sidebar of template hierarchies link.

## [3.6.1] - 2026-08-12 - Clinician Portal Improvements
...
- Allow clinicians and clinics to create template hierarchies.

### Fixed

- Fixed a bug where the bespoke onboarding with template programs could crash if the user didn’t select a program to do.
- Fix error when re-assigning a video removed from a client’s hierarchy.

### Updated

- Update to latest version of ShipBob API.

## [3.5.1] - 2026-08-05 - Clinician Portal Improvements

### Added

- Improved internal visibility of new clinic sign ups.

### Fixed

- Fix error when making a content request.
- Fix error when invalid address is used when ordering a new headset.
...
- Added tweak to template program selection page in the onboarding UI.
- Add admin tool to generate new psychoeducation content.
...
- Upgrade to new version of Sidekiq.

### Fixed

- Fix issue editing clinic users in admin.
- Small tweaks to content security policy.

## [3.3.0] - 2026-06-22 - Dependency Updates

### Updated

- Update Ruby version to 4.0.x

## [3.2.2] - 2026-06-21 - Clinician Portal Improvements

### Updated

- Improvements to onboarding workflows.

### Added

- Improvements to subscription prospect visibility.
- Add backend support for custom video recommendations for portal users.
- Add icon for trypophobia.
- Simplify admin management of site-wide announcement banners.
...
- Add free and paid tiers for clinicians so that clinics can progressively onboard their users to a paid plan.
...
-   Updated the `headset_delivered` field on the client table so that it always sends through the “large” headset now.
-   Updated the content request mailer email template to give more relevant information.    
-   Updated the placeholder text for the content request prompt input box.    
-   Only show relevant tax ID (GST, VAT, etc) on subscription invoices.    
-   Fixes for editing clinicians in admin HQ.    
-   Update system dependencies.    
-   Add additional domains to content security policy.
...
- Fix error generating hierarchies in certain rare situations.
...
- Added the AI Chat Guide to help clinicians use the portal.
- Add some additional metrics for performance monitoring of the server.

## [2.15.0] - 2026-04-21 - Clinician Portal Improvements

### Added

- Preparations for custom onboarding.

### Changed

- Update minimum mobile app verison.

### Updated

- Live session v0.19.0.
- WebXR v0.21.0.

## [2.14.0] - 2026-04-19 - Verification Improvements

### Changed

- Improve email verification flow when onboarding as a new clinic.
...
- Add some additional database optimisations to make analytics and reporting faster.

### Updated

- Update shared dependencies.

## [2.11.12] - 2026-04-01 - Backend Improvements

### Added

- Added a new table and functionailty to track the number of page views for the different pages in the portal
...
- Update content security policy to fix HotJar error.
...
- Added the games UI/UX to the portal, so that clinicians can add games to their client’s hierarchies

### Changed

- Updated minimum app version number to 1.85.0

## [2.11.8] - 2026-03-11 - Backend Fixes

### Fixed

- Fix Pipedrive CRM integration for new clinics.

## [2.11.7] - 2026-03-09 - Clinician Portal Improvements

### Added

- Record app version in use by clients.

### Fixed

- Fix seeding for developers.
- Fix ShipBob webhook errors.

## [2.11.6] - 2026-03-08 - Dependency Updates

### Changed

- Update rack dependency to latest major version.

## [2.11.5] - 2026-03-08 - Clinician Portal Improvements

### Changed

- Start enforcing expiration times of clinician invites.

### Added

- Add in `game_details` field to `/hierarchies` API call.
- Add coding agent readme files.

### Fixed

- Add HotJar resources to content security policy.
...
- Upgrade to Hanami 2.3.
- Update shared dependencies to address security alerts.
...
- Additional flexibility for access codes feature flags.
- Update system dependencies.

### Added

- Add a link in sidebar for inviting team members, and logging in to community support forum.
- Remember requested page when logging in to portal, specifically enabling seamless login to the community support forum.

## [2.10.3] - 2026-02-18 - Backend Improvements

### Added

- Achieve 100% internal test coverage.

## [2.10.2] - 2026-02-17 - Backend Improvements

### Added

- Add a tool to merge duplicate videos in admin.

## [2.10.1] - 2026-02-16 - v2.10.1

### Changed

- Update minimum app version to support new types of programs.
...
- Fix error previewing videos in certain scenarios.

## [2.9.9] - 2026-02-10 - Backend Improvements

### Changed

- Internal refactoring of database logic to reduce duplicated files and boilerplate code, in preparation for future version updates of shared frameworks.

## [2.9.8] - 2026-02-10 - Backend Improvements

### Changed

- Remove target platform detection from live session availability API now that all apps are sending it as a required parameter.
- Simplify live session availability API tests to make them run significantly faster.
...
- Internal code refactoring of mappers to prepare for dependency upgrades.

## [2.9.5] - 2026-02-08 - Dependency Updates

### Changed

- Update Ruby version.

## [2.9.4] - 2026-02-08 - Clinician Portal Improvements

### Added

- Icon for nyctophobia.
- New prompt for ordering free headset if not claimed during onboarding.
...
- Automatically analyse videos and generate metadata about them.
- Added new status options to clinic filtering on admin site.
- Added the ability to create, edit and add a game through the admin site.
- Order routing logic for headset logistics.
- Additional admin features for removing client records.

### Changed

- Fix error syncing clinician records to CRM in certain scenarios.

### Fixed

- Fix filtering bug on admin clinicians page.
- Better handling of certain scenarios when inviting clinicians.

## [2.9.1] - 2026-01-26 - Clinician Portal Improvements

### Added

- Admin improvements for managing duplicate clinic registrations.

### Changed

- Fix validation corner case when registering.
...
- Create a test client and suggested hierarchy during onboarding.
- Send out a free headset during onboarding.
- Improve security of certain APIs.

### Changed

- Improve messaging on smartphone status tab.

### Fixed

- Fix error seeding demo data in certain rare scenarios.
- Fix API schema discrepancies.

### Removed

- Continue with code cleanups.
...
- Update promo offer text.
- Fix validation error when entering a negative age.
- Simplify developer tooling by removing unused dependencies.

### Updated

- Dependency updates to address security alerts.

## [2.6.6] - 2025-12-21 - Clinician Portal Improvements

### Added

- Icons for new content categories.
...
- UI improvements to admin interface.
- Simplified CTAs in clinician portal for access code users.

## [2.6.3] - 2025-12-08 - Clinician Portal Improvements

### Added

- Add icon for school exposure content.

### Removed

- Remove deprecated code for geolocation.
- Simplify code paths by removing dead code.

### Fixed

- Fix bug when viewing video with tags.
