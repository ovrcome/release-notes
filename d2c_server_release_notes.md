...
## [1.5.3] - 2026-08-31 - Backend Improvements

### Changed

- Update payment processing logic to handle tax calculations on headsets.

## [1.5.2] - 2026-08-20 - Dependency Updates

### Updated

- Update system dependencies.

## [1.5.1] - 2026-08-12 - Dependency Updates

### Updated

- Upgrade ShipBob API to latest version.

## [1.5.0] - 2026-07-30 - Subscription Improvements

### Changed

- All new subscriptions are now handled by Stripe, and tax details collected as part of all transactions.

## [1.4.31] - 2026-07-27 - Backend Improvements
...
- Improve display of categories in admin UI.
...
## [1.4.27] - 2026-04-15 - Backend Improvements

### Updated

- Fix to handle updated hierarchy generation function parameters.

## [1.4.26] - 2026-04-13 - Backend Improvements

### Updated

- Update shared dependencies with latest security fixes.
- Allow additional oVRcome origins to access the phone compatibility checker page.
- Remove checks for “too large” phones now that we only ship large headsets.

## [1.4.25] - 2026-04-01 - Backend Improvements

### Fixed

- Exclude test users from bespoke pending users report.
...
- Fix error syncing deprecated users to MailerLite.

## [1.4.22] - 2026-03-11 - Dependency Updates

### Updated

- Update shared dependencies to address security warnings.

### Added 

- Record app version of clients when opening app.
...
- Allow disabling old programs.
- Upgrade v1 programs to work with v2 equivalents.
- Expose program version to apps.

## [1.4.19] - 2026-02-03 - Backend Improvements

### Added

- Add flag to prepare for new types of programs in the app.

### Fixed

- Fix bug calculating a user’s progress when they first start a new program.

## [1.4.18] - 2026-01-26 - Device Compatibility Tool Improvements

### Changed

- Improvements to device compatibility lookup page.
- Improvements to backend logic to handle updated programs.

### Added

- Analytics to track device compatibility lookups.

### Removed

- Removed deprecated code from old authentication process.
